          ...
          <div class="menu-links">
            <ul class="main-menu rest">
              <li @mouseenter="handleMouseEnter" @mouseleave="handleMouseLeave">
                <div class="o-hidden">
                  <a href="/" class="link animsition-link" @click="closeMenu"><span class="link dmenu" @click="handleOpenDMenu"><span class="nm">01.</span>Home </span></a>
                </div>
                <!-- <div class="sub-menu">
                  <ul class="rest">
                    <li>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <ul class="rest">
                        <li>
                          <div class="o-hidden">
                            <a href="/portfolio" class="sub-link animsition-link" @click="closeMenu">3d & Photoshop</a>
                          </div>
                        </li>
                        <li>
                          <div class="o-hidden">
                            <a href="/carousel-slider" class="sub-link animsition-link" @click="closeMenu">Video Editing</a>
                          </div>
                        </li>
                        <li>
                          <div class="o-hidden">
                            <a href="/fullscreen" class="sub-link animsition-link" @click="closeMenu">Environment Design</a>
                          </div>
                        </li>
                        <!-- <li>
                          <div class="o-hidden">
                    ...
                    <div class="col-md-6">
                      <ul class="rest">
                        <li>
                          <div class="o-hidden">
                            <a href="/half-slider" class="sub-link animsition-link" @click="closeMenu">Branding</a>
                          </div>
                        </li>
                        <li>
                          <div class="o-hidden">
                            <a href="/portfolio-fixed-text" class="sub-link animsition-link"
                              @click="closeMenu">Web Development</a>
                          </div>
                        </li>
                        <!-- <li>
                          <div class="o-hidden">
                        ...
                        <li>
                          <div class="o-hidden">
                            <a href="/portfolio-grid-classic" class="sub-link animsition-link" @click="closeMenu">AI Generations</a>
                          </div>
                        </li>
                        <!-- <li>
                          <div class="o-hidden">
        ...
        <div class="col-lg-4 valign">
          <div class="cont-info">
            <div class="item mb-50">
              <h6 class="text-u fw-600 mb-20">I'm From</h6>
              <p class="fw-400 fz-18">26002, Lucknow Cantt, Uttar Pradesh, India</p>
            </div>
            <div class="item mb-50">
              <h6 class="text-u fw-600 mb-20">How to Connect</h6>
              <p class="fw-400 fz-18">+91 991 96820 59</p>
              <p class="fw-400 fz-18">singhnature41@gmail.com</p>
            </div>
            <div class="bottom">
