            ...
            <div :class="`container ${item.videoSource ? 'ontop' : ''}`">
              <div class="row">
                <div class="col-lg-11 offset-lg-1">
                  <div class="caption">
                    <h6 class="sub-title mb-30" :data-swiper-parallax="-1000">© 2025 <br /> {{ item.caption.subTitle }}
                    </h6>
                    <h1>
...
import { Navigation, Autoplay, Parallax, Pagination, Mousewheel } from 'swiper/modules';
    ...
    renderBullet(_, className) {
      return `<span class="${className}">
        <svg class="fp-arc-loader" width="16" height="16" viewBox="0 0 16 16">
          <circle class="path" cx="8" cy="8" r="5.5" fill="none" transform="rotate(-90 8 8)" stroke="#FFF" stroke-opacity="1" stroke-width="1px" />
